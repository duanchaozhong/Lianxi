		...
		switch (refreshResult)
		{
			case SUCCEED:
				...
				refreshStateImageView
						.setBackgroundResource(R.drawable.gif_loading3);
				break;
			case FAIL:
			default:
				// 刷新失败
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		switch (refreshResult)
		{
			case SUCCEED:
				...
				loadStateImageView.setBackgroundResource(R.drawable.p10);
				break;
			case FAIL:
			default:
				// 加载失败
				...
				loadStateImageView.setBackgroundResource(R.drawable.p11);
				break;
		}
		if (pullUpY < 0)
		{
