...
import activity28.CompressHelper;
import activity28.FileUtil;
...
public class Main28Activity extends AppCompatActivity {
    ...
    private File oldFile;       //原始文件
    private File newFile;       //压缩后的文件
    ...
    public void compress(View view) {
      ...
      //  newFile = CompressHelper.getDefault(getApplicationContext()).compressToUri(Uri.parse("http://pic.qiantucdn.com/58pic/17/98/94/58PIC9K58PIC298_1024.jpg"));
